...
\myname{Li}{Zi\bibnamedelima kang}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Li Zi kang, Master}

  \makefield{\faEnvelopeO}{\texttt{kk1996@mail.ustc.edu.cn}}
  \makefield{\faGithub}{\texttt{@Dis-count}}}
